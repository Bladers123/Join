...
async function editTask() {
    ...
    document.getElementById('cardModal-container').innerHTML = editTaskTemplate(editPrio);
    editSubtasksArray();
    editAssignsArray();
}
...
function editTaskTemplate(editPrio) {
    return /*html*/`
                ...
                <div class="task d-column">
                    <div class="taskLeftSide">
                        <div class="margin-bot">
                            ...
                            <input id="input-title" placeholder="${currentTaskModal.title}" value="${currentTaskModal.title}" class="inputs" type="text" required />
                        </div>
                        <div class="margin-bot">
                            <p>Description</p>
                            <textarea id="textArea-description" placeholder="${currentTaskModal.description}" value="${currentTaskModal.description}" class="textarea"></textarea>
                        </div>
                    ...
                    <div class="taskRightSide">
                        <div class="margin-bot">
                            ...
                            <input id="input-due-date" placeholder="${currentTaskModal.dueDate}" value="${currentTaskModal.dueDate}" class="inputs" type="date" required />
                        </div>
                        <div class="margin-bot">
                            <p>Prio</p>
